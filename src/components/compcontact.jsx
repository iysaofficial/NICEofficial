                            ...
                            <div className="row align-items-center">
                                <div className="wrapper">
                                    <div className="inner-hmv" >
                                        ...
                                        <h4 className="text-center"><a href="https://goo.gl/maps/muWqimWHYjAgWSaQ8"
                                        target="_blank">Jalan Kemang No. 63 RT. 3 RW. 6, Pasir Putih Sawangan
                                            Kota Depok, Jawa Barat 16511, Indonesia.</a></h4>
                                    </div>
                                    ...
                                    <div className="inner-hmv" >
                                        ...
                                        <h5 className="text-center"><a href="https://wa.me/6281770914129"
                                        target="_blank">0817 - 7091 - 4129</a></h5>                                                
                                    </div>
                                    ...
                                    <div className="inner-hmv" >
                                        ...
                                        <h5 className="text-center"><a href="mailto:niceofficial.iysa@gmail.com"
                                        target="_blank">
                                        niceofficial.iysa@gmail.com</a></h5>
                                    </div>
                                </div>
                            </div>
